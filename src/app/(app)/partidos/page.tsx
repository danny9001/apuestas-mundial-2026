...
export default function PartidosPage() {
  ...
  return (
    <section className="space-y-6">
      ...
      {/* Fase filter - sticky: top-14 en mobile (debajo del header ~56px), top-0 en desktop */}
      <div className="sticky top-16 md:top-0 z-20 bg-neutral-950 pt-1 pb-2 space-y-2">
