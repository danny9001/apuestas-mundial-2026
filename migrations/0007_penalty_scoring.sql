-- Migration 0007: Penalty scoring support
-- Adds: penalty winner scoring in recalculate_leaderboard()
-- Also adds events support via stats JSONB (no schema change needed)
